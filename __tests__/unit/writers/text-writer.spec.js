...
it("Should throw an error when filename couldn't be parse", () => {
  parse.mockImplementation(() => {
    throw new TypeError("Some parse error");
  });

  expect(() => {
    textWriter(null, "Hello world!");
  }).toThrowError("Invalid filename argument");
...
it("Should throw an error when given an invalid filename", () => {
  ...
  slugify.mockImplementation(() => {
    throw new TypeError("Some slugify error");
  });
